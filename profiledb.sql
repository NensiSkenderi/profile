...
CREATE TABLE `data` (
  ...
  `CCSecurityCode` varchar(32) DEFAULT NULL,
...
INSERT INTO `data` VALUES (1,'test','test','test','test','test','test','test','test','test','test','test'),(2,'aaaaaa','aaaaaaa','aaaaaaa','aaaaaaa','aaaaaa','aaaaaa','aaaaa','aaaaaa','aaaaaaa','aaaaaa','aaaaa');
...
-- Dump completed on 2020-10-15  4:30:29
